A Terraform/CX as Code remote module for the following Genesys Cloud public API operation: Manually Assign Agent to Conversation
...
```hcl
module "data_action" {
    source             = "git::https://github.com/GenesysCloudDevOps/public-api-manually-assign-agent-to-conversation-data-action-module.git?ref=v1.0.0"
    action_name        = "Manually Assign Agent to Conversation"
